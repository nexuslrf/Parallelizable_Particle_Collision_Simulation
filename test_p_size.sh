...
echo "5000 20000 1 50 perf" > input_p.txt
...
tail -n 2 outputs_${run_program}_${input_file}
echo ""
echo "20000 20000 1 50 perf" > input_p.txt
...
tail -n 2 outputs_${run_program}_${input_file}
echo ""
echo "30000 20000 1 50 perf" > input_p.txt
...
tail -n 2 outputs_${run_program}_${input_file}
echo ""
echo "40000 20000 1 50 perf" > input_p.txt
...
tail -n 2 outputs_${run_program}_${input_file}
echo ""
echo "50000 20000 1 50 perf" > input_p.txt
