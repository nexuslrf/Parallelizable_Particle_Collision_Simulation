...
echo "10000 5000 1 50 perf" > input_p.txt
...
tail -n 2 outputs_${run_program}_${input_file}
echo ""
echo "10000 10000 1 50 perf" > input_p.txt
...
tail -n 2 outputs_${run_program}_${input_file}
echo ""
echo "10000 100000 1 50 perf" > input_p.txt
...
tail -n 2 outputs_${run_program}_${input_file}
echo ""
echo "10000 1000000 1 50 perf" > input_p.txt
...
tail -n 2 outputs_${run_program}_${input_file}
echo ""
echo "10000 10000000 1 50 perf" > input_p.txt
